...
async def send_code_promotion(channel):
	promote_msg=discord.Embed(title="__**SUPPORT THE SERVER**__", description="use code **sarwin** in the _*Fortnite Item Shop*_ or in _Epic Games Luncher_ when purchasing cosmetic items or games.", color=0x00fbff)
	promote_msg.set_footer(text="- doing so improves your game sense and mechanics by 249% [not proven]")
